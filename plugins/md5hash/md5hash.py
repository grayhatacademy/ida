# The Python bundled with IDA doesn't have a functioning hashlib.
# Unfortunately, sometimes it is necessary or more convenient to use the bundled python.
# Many scripts/plugins *assume* hashlib works, causing them to fail.
